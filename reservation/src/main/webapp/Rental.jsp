...
<br>
	...
	<form id="rentalForm" action="RentalServlet" method="post">
		...
		<label for="checkoutdate" style="color: blue;">Check in date:</label>
        <input type="date" id="checkoutdate"placeholder="Check in date" autocomplete="off" name="checkoutdate" required>
        <br>
        <br>
        <br>
        
        <label for="chechoutday" style="color: blue;">Check out date:</label>
        <input type="date" id="chechoutday"placeholder="Check out date:" autocomplete="off" name="chechoutday" required>
        <br>
		<br>
        <br>
